...
export function Header() {
  return (
    <div
      ...
      <div className="bg-green-600 bg-opacity-85 text-white">
        <header className="py-2.5 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex justify-between items-center">
              ...
              <nav className="flex space-x-4 md:space-x-8 justify-between items-center">
                <Link to="/" className="relative group">
                  <span className="hover:text-slate-100 transition-colors duration-300">
                    Home
                  </span>
                ...
                <Link
                  to="/login"
                  className="bg-green-700 text-sm py-1.5 px-3 rounded-[4px] transition-all transform duration-[400ms] ease-in-out hover:bg-green-800 hover:shadow-md hover:scale-105 hover:font-semibold">
